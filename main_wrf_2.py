...
class App(QMainWindow): 
    ...
    def onClick(self):
        ...
        if self._increment:
            ...
            self.buttons.showLists.connect(self.windows.eventShowLists)
...
class Buttons(QWidget):
    ...
    def initUI(self):
        ...
        self.but1.clicked.connect(self.showLists)
    ...
    def showListsEvent(self, event):
        self.showLists.emit(event)
        event.accept()
